...
export { Datatable2 as Datatable } from "./Datatable2";
export type { DatatableProps } from "./Datatable2/DatatableTypes";
export type { HeaderRowFilterProps as DatatableHeaderRowFilterProps } from "./Datatable2/DatatableTypes";
